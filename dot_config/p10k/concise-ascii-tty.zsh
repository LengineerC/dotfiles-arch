# Standalone ASCII Powerlevel10k configuration for Linux virtual consoles and plain TTYs.
#
# Based on concise-icon-adaptive.zsh. This is a self-contained file and emits only ASCII prompt
# content. Semantic states use the terminal's ANSI palette, while brand accents use 256 colors.
...
() {
  ...
  function prompt_zsh_logo() {
    p10k segment -t '%F{cyan}>_%f %F{green}zsh%f'
  }
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%F{cyan}'
      local conflicted='%F{red}'
    else
      # Styling for incomplete and stale Git status.
      local       meta='%F{grey}'  # terminal-palette grey foreground
      local      clean='%F{grey}'  # terminal-palette grey foreground
      local   modified='%F{grey}'  # terminal-palette grey foreground
      local  untracked='%F{grey}'  # terminal-palette grey foreground
      local conflicted='%F{grey}'  # terminal-palette grey foreground
    fi
  ...
  typeset -g POWERLEVEL9K_TIMEWARRIOR_CONTENT_EXPANSION='${P9K_CONTENT:0:21}${${P9K_CONTENT:21}:+...}'
  ...
  typeset -g POWERLEVEL9K_IP_CONTENT_EXPANSION='$P9K_IP_IP${P9K_IP_RX_RATE:+ %70Fv$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %215F^$P9K_IP_TX_RATE}'
...
() {
  ...
  # Keep the prompt transparent. Neutral decoration and semantic state colors use ANSI names,
  # so the most important contrast still follows the terminal theme.
  ...
  # ANSI approximations of language brand colors, kept consistent across related segments.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND=yellow
  typeset -g POWERLEVEL9K_ASDF_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_ASDF_{PYTHON,GOLANG,FLUTTER,LUA,PERL,POSTGRES}_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_ASDF_{NODEJS,JULIA}_FOREGROUND=green
  typeset -g POWERLEVEL9K_ASDF_{RUST,JAVA,HASKELL}_FOREGROUND=yellow
  typeset -g POWERLEVEL9K_ASDF_{RUBY,ERLANG}_FOREGROUND=red
  typeset -g POWERLEVEL9K_ASDF_{DOTNET_CORE,ELIXIR,PHP}_FOREGROUND=magenta
  typeset -g POWERLEVEL9K_{VIRTUALENV,ANACONDA,PYENV,GOENV}_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_{NODENV,NVM,NODEENV,NODE_VERSION}_FOREGROUND=green
  typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_{RUST_VERSION,JAVA_VERSION,HASKELL_STACK}_FOREGROUND=yellow
  typeset -g POWERLEVEL9K_{DOTNET_VERSION,PHP_VERSION,PHPENV}_FOREGROUND=magenta
  typeset -g POWERLEVEL9K_{LARAVEL_VERSION,PACKAGE,RBENV,RVM,SCALAENV}_FOREGROUND=red
  typeset -g POWERLEVEL9K_FVM_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_LUAENV_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_JENV_FOREGROUND=yellow
  typeset -g POWERLEVEL9K_{PLENV,PERLBREW}_FOREGROUND=cyan

  # ANSI approximations of infrastructure brand colors.
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_{TERRAFORM_OTHER,TERRAFORM_VERSION}_FOREGROUND=magenta
  typeset -g POWERLEVEL9K_{AWS_DEFAULT,AWS_EB_ENV,TOOLBOX}_FOREGROUND=yellow
  typeset -g POWERLEVEL9K_{AZURE_OTHER,GCLOUD,GOOGLE_APP_CRED_DEFAULT,NORDVPN}_FOREGROUND=cyan
  typeset -g POWERLEVEL9K_{RANGER,YAZI,NNN,LF,XPLR,VIM_SHELL,MIDNIGHT_COMMANDER}_FOREGROUND=yellow
  ...
  typeset -g POWERLEVEL9K_PER_DIRECTORY_HISTORY_LOCAL_FOREGROUND=magenta
