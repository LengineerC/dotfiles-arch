...
# Generated by Powerlevel10k configuration wizard on 2026-08-24 at 11:01 CST.
...
() {
  ...
  #   U+E0B6   LEFT HALF CIRCLE / round left
  #   U+E0B4   RIGHT HALF CIRCLE / round right
  #   U+E0B2   LEFTWARDS BLACK ARROW / powerline left
  #   U+E0B0   RIGHTWARDS BLACK ARROW / powerline right
  ...
  # Custom icon.
  # typeset -g POWERLEVEL9K_OS_ICON_CONTENT_EXPANSION='OS'
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIINS_CONTENT_EXPANSION='%F{242}╰─%F{76}$%f'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIINS_CONTENT_EXPANSION='%F{242}╰─%F{196}$%f'
  # Command mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VICMD_CONTENT_EXPANSION='%F{242}╰─%F{76}$%f'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VICMD_CONTENT_EXPANSION='%F{242}╰─%F{196}$%f'
  # Visual mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIVIS_CONTENT_EXPANSION='%F{242}╰─◆%F{76}$%f'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIVIS_CONTENT_EXPANSION='%F{242}╰─◆%F{196}$%f'
  # Overwrite mode
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_VIOWR_CONTENT_EXPANSION='%F{242}╰─%F{76}$%f'
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_VIOWR_CONTENT_EXPANSION='%F{242}╰─%F{196}$%f'
