# Standalone adaptive ANSI-palette Powerlevel10k configuration.
#
# Initially based on concise-icon.zsh. This is a self-contained file: it doesn't source any of
# the other configurations in this directory. Semantic states use the terminal's ANSI palette,
# while a restrained set of 256-color accents gives ordinary segments more visual depth.
...
() {
  ...
  function prompt_zsh_logo() {
    p10k segment -t '%F{cyan}󰆍%f %F{green}zsh%f'
  }
...
() {
  ...
  # Language segments use fixed 256-color approximations of their brand colors. The same language
  # keeps the same color across asdf, its version segment and its environment/version manager.
  ...
  typeset -g POWERLEVEL9K_ASDF_ELIXIR_FOREGROUND=129
  typeset -g POWERLEVEL9K_ASDF_PHP_FOREGROUND=99
  typeset -g POWERLEVEL9K_ASDF_HASKELL_FOREGROUND=140
  typeset -g POWERLEVEL9K_{VIRTUALENV,ANACONDA,PYENV}_FOREGROUND=37
  typeset -g POWERLEVEL9K_GOENV_FOREGROUND=38
  typeset -g POWERLEVEL9K_{NODENV,NVM,NODEENV,NODE_VERSION}_FOREGROUND=70
  ...
  typeset -g POWERLEVEL9K_PACKAGE_FOREGROUND=160
  typeset -g POWERLEVEL9K_{RBENV,RVM}_FOREGROUND=168
  typeset -g POWERLEVEL9K_FVM_FOREGROUND=38
  typeset -g POWERLEVEL9K_LUAENV_FOREGROUND=32
  typeset -g POWERLEVEL9K_JENV_FOREGROUND=166
  typeset -g POWERLEVEL9K_{PLENV,PERLBREW}_FOREGROUND=67
  typeset -g POWERLEVEL9K_PHPENV_FOREGROUND=99
  typeset -g POWERLEVEL9K_SCALAENV_FOREGROUND=160
  typeset -g POWERLEVEL9K_HASKELL_STACK_FOREGROUND=140

  # Branded infrastructure tools use stable colors: Kubernetes/Google/Azure blue, Terraform
  # purple and AWS orange. Generic shell state below continues to follow the terminal palette.
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=39
  typeset -g POWERLEVEL9K_{TERRAFORM_OTHER,TERRAFORM_VERSION}_FOREGROUND=99
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=208
  typeset -g POWERLEVEL9K_AWS_EB_ENV_FOREGROUND=208
